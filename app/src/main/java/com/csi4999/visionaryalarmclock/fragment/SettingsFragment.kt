...
import com.csi4999.visionaryalarmclock.databinding.FragmentSettingsBinding
...
class SettingsFragment : Fragment(), View.OnClickListener {
    ...
    private fun initAllControls() {
        ...
        fragmentSettingsBinding.switchDarkMode.isChecked = mySharedPreferences.isDarkModeOn()=="true"

        fragmentSettingsBinding.switchDarkMode.setOnCheckedChangeListener { _, b ->
            if (b) {
        ...
        fragmentSettingsBinding.tvSettingsFontSize.text = mySharedPreferences.getFontSize()
